	...
	If Type("oNF:_InfNfe:_infAdic:_infCpl:TEXT")<>"U"
		...
		If !Empty(cAux)
			...
			For i:=1 to Len(aAux)
				cAux := aAux[i]
				While !Empty(cAux)
					aadd(aMensagem, { SubStr(cAux,1,MAXMENLIN), .F. } )
...
EndIf
	...
	*/
	...
	// FIBRASA - Alteracao - Removendo Linha abaixo
	...
	oDanfe:Say(095,266, "1-SAÝDA"  ,oFont08:oFont)
	...
	oDanfe:Say(224,504,"DATA ENTRADA/SAÝDA",oFont08N:oFont)
	// FIBRASA - Alteracao - Removendo Linha abaixo
	// oDanfe:Say(233,504,Iif( Empty(aDest[4]),"",ConvDate(aDest[4]) ),oFont08:oFont)
	oDanfe:Box(236,502,257,603)
	oDanfe:Say(243,503,"HORA ENTRADA/SAÝDA",oFont08N:oFont)
	// FIBRASA - Alteracao - Removendo Linha abaixo
	...
	oDanfe:Say(372+nAjustaVt,375,"PLACA DO VEÝCULO",oFont08N:oFont)
	...
	oDanfe:Say(696,302,"BASE DE CÝLCULO DO ISSQN",oFont08N:oFont)
	...
	For nY := 1 To nLenItens
		...
		If lflag
			If nL > nMaxItemP2
				...
				oDanfe:Say(053+nLinhavers,255, "1-SAÝDA"  ,oFont08:oFont)
		...
		If	nL > Iif( (nfolha-1)%2==0 .And. MV_PAR05==1,MAXITEMP3,nMaxItemP2)
			...
			oDanfe:Say(053,255, "1-SAÝDA"  ,oFont08:oFont)
...
Static Function SimpDanfe(oDanfe,oNfe,cCodAutSef,cModalidade,oNfeDPEC,cCodAutDPEC,cDtHrRecCab,dDtReceb,aNota)
	...
	*/
	...
	oDanfe:Say(105,266, "1-SAÝDA"  ,oFont08:oFont)
	...
	*/
	...
	oDanfe:Say(234,504,"DATA ENTRADA/SAÝDA",oFont08N:oFont)
	oDanfe:Say(243,504,Iif( Empty(aDest[4]),"",ConvDate(aDest[4]) ),oFont08:oFont)
	oDanfe:Box(246,502,267,603)
	oDanfe:Say(255,503,"HORA ENTRADA/SAÝDA",oFont08N:oFont)
