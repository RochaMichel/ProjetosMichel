...
Static Function ReprNum(cAgencia,cConta,DVX,lNF,_pref,_titulo,_parc)
	...
	cBanco       := '0339'                                             // Codigo do banco Itaú
...
Static Function Impress(oBol,aDadosEmp,aDadosTit,aDadosBanco,aDatSacado,aBolText,aCB_RN_NN)
	...
	For nW:= 1 to 3
		...
		oBol:Say(_nLin+100,0648,"033-7",oFont20b,100)                // Codigo do banco
...
User Function B033WS(_filial,_titulo,_pref,_client,_loja,_parc)
