...
Static Function EnvPdfZum ()
	...
	Local aEmailCli := Separa(AllTrim(Posicione("SA3",1,xFilial("SA3") + M->C5_VEND1,"A3_EMAIL")),";")// pegando Email do vendedor representante 
	...
	U_EnvPdfZum('contato.michelrocha@gmail.com',cAssunto,cMsg)// função para montar o pdf e enviar para o representante
	//U_EnvPdfZum("rivaldogfj@hotmail.com",cAssunto,cMsg)
