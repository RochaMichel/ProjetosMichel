...
User Function ImpCsvC()
	...
	oSayArq := tSay():New(15,07,{|| "Este programa tem como objetivo importar a longitude e latitude do cliente , onde os mesmos serão importados e diretamente alterados "+;
...
Static Function Update(cLAT,cLONG,cCGC)
	...
	IF dbseek(FWxfilial("SA1")+PADR(cCGC,TAMSX3("A1_CGC")[1]))
		...
		cErro += "Cliente com CPF/CNPJ "+cCGC+" Não cadastrado" + CRLF
	ENDIF
