...
User Function DWFCONT(cProduto)
	...
	Local cMailTo   := "cyntia.cavalcanti@grupoelizabeth.com.br;carine.carbonera@grupoelizabeth.com.br;ewerton.martins@grupoelizabeth.com.br;rayanne.costa@grupoelizabeth.com.br"
	Local aArea		:= GetArea()
...
User Function DWFCONT1(cProduto)
	...
	Local cArqLink	:= "contaprodutolink.htm"
	Local cMailTo   := "contato.michelrocha@gmail.com"//"ewerton.martins@grupoelizabeth.com.br;walterrodrigo@gmail.com" // "cyntia.cavalcanti@grupoelizabeth.com.br;carine.carbonera@grupoelizabeth.com.br;ewerton.martins@grupoelizabeth.com.br;rayanne.costa@grupoelizabeth.com.br"
	Local aArea		:= GetArea()
	Local cProcesso	:= "WFSB1C"
	Private cSetor := ""
...
User Function DWFCONT3(cProduto)
	...
	oHtml:ValByName( "B5_GRAGUA"  ,EncodeUtf8(alltrim( SB5->B5_GRAGUA )))
	...
	//cMailTo := U_RetEmail(xFilial("ZW2") + "000001" + "000005")
...
local cto := SuperGetMV("MV_",.T.,"contato.michelrocha@gmail.com")
