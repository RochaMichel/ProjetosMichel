...
User Function DWFRCON1(oProcess)
	...
	Aadd(aProd, {"B1_XACABAM", AllTrim(UPPER(oProcess:oHTML:RetByName("B1_XACABAM" ))), NIL })
...
User Function DWFRCON3(oProcess)
	...
	If SB5->(dbseek(xFilial('SB5')+cProduto))
		...
		Aadd(aProd2,{"B5_GRAGUA", oProcess:oHTML:RetByName("B5_GRAGUA"), NIL})
...
Static Function EnvConfPrd(cProduto, cConta)
	...
	Local cPara      := "contato.michelrocha@gmail.com"//"nucleo.cadastral@grupoelizabeth.com.br;cyntia.cavalcanti@grupoelizabeth.com.br;carine.carbonera@grupoelizabeth.com.br;rayanne.costa@grupoelizabeth.com.br"
	Local cCopia     := ""
	Local cConhCopia := ""
