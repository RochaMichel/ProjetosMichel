         ...
         aBanco := {AllTrim(SA6->A6_COD),;                                                             // 01 - Numero do Banco
                    ...
                    IIf(SEE->EE_TPCOBRA == "1",;
                      IIf(AllTrim(SA6->A6_COD) == "104","RG",;
                       IIf(AllTrim(SA6->A6_COD) == "033",AllTrim(SEE->EE_CODCART),AllTrim(SEE->EE_CODCART))),;
...
/*  If aBanco[1] == "104"
  ...
  If aBanco[1] == "033"
     oPrint:Say(nRow2 + 1010,505,aBanco[10], oFont10)
   else
...
/*  If aBanco[1] == "104"
  ...
  If aBanco[1] == "033"
     oPrint:Say(nRow3 + 2300,505,aBanco[10],oFont10)
   else
